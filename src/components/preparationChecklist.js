...
export default class PreparationChecklist extends Component {
  ...
  renderCells = () => {
   ...
   handleNextJobNumber = async() => {
    debugger
    if (this.state.prepCheckJobNum > this.props.chats.Jobs.length - 1){
      await this.setState({prepCheckJobNum:Object.keys(this.props.chats.Jobs)[0]})
    }else(
      await this.setState({prepCheckJobNum:Object.keys(this.props.chats.Jobs)[this.state.prepCheckJobNum + 1]})
    )
  }
      ...
      return (
        <div>
          <div className="preparation-checklist-container">
            ...
            <img onClick={this.handleNextJobNumber} className="arrowRight" src="./assets/arrowRight.png" alt="arrowRight"/>
            </h4>
...
//
//             <h4>For Job#
//             <img className="arrowRight" src="./assets/arrowRight.png" alt="arrowRight"/>
//             </h4>
//
//             <header className="preparation-checklist-cells-container">
//               {this.renderCells()}
